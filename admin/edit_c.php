...
<body style="background: url(hexa.gif);">
	...
	<center>
		...
		<div class="inputicon">
			<h1 style="color: powderblue; font-family: Lobster, cursive;">update categories</h1>
			<input type="text" name="category" value="<?php echo $tt; ?>"/>
...
<?php
	if (isset($_POST['submit'])) 
	{
		...
		$query = "UPDATE categories SET cat_title='$cate' WHERE cat_id='$ti'";
